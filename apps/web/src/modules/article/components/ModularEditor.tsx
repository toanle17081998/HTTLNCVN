...
export const ModularEditor = forwardRef(function ModularEditor(
  ...
  return (
    <div className={cn("flex flex-col overflow-hidden rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-card)]", className)}>
